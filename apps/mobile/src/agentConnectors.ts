...
//
// Owner-only. Kept identical to web/lib/agentConnectors.ts (the parity test asserts
// the two agree). The backend is the enforcer; this is display + the value the owner
// PUTs to `…/connectors/:cid/trust`.
