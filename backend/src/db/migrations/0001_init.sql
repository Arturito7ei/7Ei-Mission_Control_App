-- 7Ei Mission Control — Initial Schema Migration
-- Run: npx drizzle-kit push (dev) | npx drizzle-kit generate + migrate (prod)
...
CREATE TABLE IF NOT EXISTS knowledge_items (
  ...
  parent_id TEXT,
  content TEXT,
  backend TEXT NOT NULL DEFAULT 'google_drive',
  created_at INTEGER NOT NULL
);
